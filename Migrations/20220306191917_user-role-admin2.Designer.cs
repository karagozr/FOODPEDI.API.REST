...
namespace FOODPEDI.API.REST.Migrations
{
    ...
    [Migration("20220306191917_user-role-admin2")]
    partial class userroleadmin2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FOODPEDI.API.REST.DataAccess.AppRole", b =>
                {
            ...
            modelBuilder.Entity("FOODPEDI.API.REST.DataAccess.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("FOODPEDI.API.REST.DataAccess.Entities.ItemComment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FOODPEDI.API.REST.DataAccess.AppUserRole", b =>
                {
                    b.HasOne("FOODPEDI.API.REST.DataAccess.AppRole", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("FOODPEDI.API.REST.DataAccess.Entities.ItemComment", b =>
                {
                    ...
                    b.HasOne("FOODPEDI.API.REST.DataAccess.Entities.ItemComment", "Parent")
                        .WithMany("ChildCommends")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("FOODPEDI.API.REST.DataAccess.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
